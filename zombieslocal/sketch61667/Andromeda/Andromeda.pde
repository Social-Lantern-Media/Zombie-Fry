/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/61667*@* */
...
void setup() {
  ...
  zombie1 = loadImage( "zombie1.gif");
  zombie2 = loadImage("zombie2.gif");
  zombie3 = loadImage("zombie3.gif");
  zombie4 = loadImage( "zombie4.gif");
